<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="bloghome.aspx.cs" Inherits="Jain_Rest.bloghome" %>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                    <div class="categories_post">
                        <img src="../templatefiles/images/blog/cat-post/cat-post-3.jpg" alt="post">
                ...
                <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                    <div class="categories_post">
                        <img src="../templatefiles/images/blog/cat-post/cat-post-2.jpg" alt="post">
                        <div class="categories_details">
                            <div class="categories_text">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="categories_post">
                        <img src="../templatefiles/images/blog/cat-post/cat-post-1.jpg" alt="post">
                        <div class="categories_details">
                            <div class="categories_text">
                            ...
                            <div class="col-md-9">
                                <div class="blog_post">
                                    ...
                                    <div class="blog_details">
                                        ...
                                        <a href="blogdetails.aspx" class="template-btn">View More</a>
                                    </div>
                                </div>
                            </div>
                        </article>
