<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login1.aspx.cs" Inherits="Jain_Rest.User.login" StylesheetTheme="Skin1" %>
...
<body>
    ...
    <form id="form1" runat="server" style=" background-color:antiquewhite; ">
        <div style="padding:180px;   color:white; ">
           <asp:Label ID="lblHeadingMsg" runat="server" 
               style=" font-family:'MS Outlook'; color:darksalmon; background-color:black;
                  ...
                  <tr>
                    ...
                    <td>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7"
                            ...
                            ErrorMessage="Username is required" ForeColor="#FF3300" SetFocusOnError="True"></asp:RequiredFieldValidator>
                ...
                <tr>
                    ...
                    <td class="auto-style6">
                        <asp:TextBox ID="txtPassword" CssClass="form-control" runat="server" 
                            TextMode="Password" Wrap="True" AutoPostBack="True"></asp:TextBox>
                        </td><td>
            ...
            <div class="btn-box" style="color:black;">
                 <asp:Button ID="btnLogin" runat="server" Text="Login" 
                    CssClass="btn btn-success rounded-pill pl-4 pr-4 text-white" OnClick="btnLogin_Click1" />
                  </div>
                </div>
